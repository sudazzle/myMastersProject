...
<title>Online Result System</title><meta name="description" content="website description"><meta name="keywords" content="website keywords, website keywords"><meta http-equiv="content-type" content="text/html; charset=windows-1252"><link rel="stylesheet" type="text/css" href="style.css" title="style"></head><body>
  <div id="main">
    <div id="header">
      ...
      <div id="menubar">
        <ul id="menu"><!-- put class="selected" in the li tag for the selected page - to highlight which page you're on --><li class = "selected"><a href = "displaybackpaper_select.jsp">BACK PAPER INFO</a></li><li><a href = "adminpage.html">admin</a></li><li><a href = "index.html">Sign Out</a></li>
...
<%
	...
	try{	
		...
		while(sem1_offer_result.next())
		{
				...
				String sem1_query = "select subject.subject_code, subject.subject_name, subject_credit, marks.grade, marks.gradepoint from subject join course_offered on subject.subject_id = course_offered.subject_id join marks on course_offered.offer_id = marks.offer_id where marks.student_id =" + student_id + " and course_offered.offer_id = " + sem1_offer_result.getInt(1) + " and marks.exam_type = 'back paper'";
...
try{	
	...
	while(sem2_offer_result.next())
	{
		...
		System.out.println("The offer id is " + sem2_offer_result.getInt(1));
	    	...
	    	String sem2_query = "select subject.subject_code, subject.subject_name, subject_credit, marks.grade, marks.gradepoint from subject join course_offered on subject.subject_id = course_offered.subject_id join marks on course_offered.offer_id = marks.offer_id where marks.student_id =" + student_id + " and course_offered.offer_id = " + sem2_offer_result.getInt(1) + " and marks.exam_type = 'back paper'";	ResultSet sem2_result = stmt2.executeQuery(sem2_query);
...
try{	
	...
	while(sem3_offer_result.next())
	{
	    	...
	    	String sem3_query = "select subject.subject_code, subject.subject_name, subject_credit, marks.grade, marks.gradepoint from subject join course_offered on subject.subject_id = course_offered.subject_id join marks on course_offered.offer_id = marks.offer_id where marks.student_id =" + student_id + " and course_offered.offer_id = " + sem3_offer_result.getInt(1) + " and marks.exam_type = 'back paper'";			ResultSet sem3_result = stmt3.executeQuery(sem3_query);
...
try{	
	...
	while(sem4_offer_result.next())
	{
	    	...
	    	String sem4_query = "select subject.subject_code, subject.subject_name, subject_credit, marks.grade, marks.gradepoint from subject join course_offered on subject.subject_id = course_offered.subject_id join marks on course_offered.offer_id = marks.offer_id where marks.student_id =" + student_id + " and course_offered.offer_id = " + sem4_offer_result.getInt(1) + " and marks.exam_type = 'back paper'";			ResultSet sem4_result = stmt4.executeQuery(sem4_query);
...
try{	
	...
	while(sem5_offer_result.next())
	{
	    	...
	    	String sem5_query = "select subject.subject_code, subject.subject_name, subject_credit, marks.grade, marks.gradepoint from subject join course_offered on subject.subject_id = course_offered.subject_id join marks on course_offered.offer_id = marks.offer_id where marks.student_id =" + student_id + " and course_offered.offer_id = " + sem5_offer_result.getInt(1) + " and marks.exam_type = 'back paper'";			ResultSet sem5_result = stmt5.executeQuery(sem5_query);
...
try{	
	...
	while(sem6_offer_result.next())
	{
	    	...
	    	String sem6_query = "select subject.subject_code, subject.subject_name, subject_credit, marks.grade, marks.gradepoint from subject join course_offered on subject.subject_id = course_offered.subject_id join marks on course_offered.offer_id = marks.offer_id where marks.student_id =" + student_id + " and course_offered.offer_id = " + sem6_offer_result.getInt(1) + " and marks.exam_type = 'back paper'";			ResultSet sem6_result = stmt6.executeQuery(sem6_query);
