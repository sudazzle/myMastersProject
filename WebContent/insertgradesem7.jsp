...
function editMarks(student_id, offer_id, batch_id){
    var f=document.form;
    f.method="post";
    f.action='edit_sem7.jsp?student_id='+student_id + '&offer_id='+ offer_id + '&batch_id='+ batch_id;
    f.submit();
}
...
<%String program = null;
  ...
  <div id="main">
    	...
    	<div id="site_content">
        	...
        	<h1><B>7th SEMESTER: REGULAR</B></h1>
            <form name ="sem_1" action="insertgradeserversem7.jsp?id_batch=<%=request.getParameter("id_batch")%>&id=<%=request.getParameter("id") %>" method="post" onsubmit="return validateForm()">
	...
	<table>
		<tr><th width="60" >&nbsp;&nbsp;Code</th><th width="200">&nbsp;&nbsp;Subject Name</th><th width="50">&nbsp;Grade</th><th>&nbsp;Exam Type</th><th></th></tr>
			...
			try{	
				...
				String sem_offer_query = "Select course_offered.offer_id from subject join course_offered on subject.subject_id = course_offered.subject_id where course_offered.batch_id ="+  id_batch + " and semester = " + 7;
