...
function displaybackpaperinfo(id, id_batch){
   var f = document.form;
	f.method="post";
   f.action='backpaperinfodisplay.jsp?id='+id + '&id_batch=' + id_batch;
     f.submit();
}
</script>
...
<body>
  ...
  <div id="main">
    ...
    <div id="site_content">
        ...
        <h1><B>BACK PAPER INFO: SELECT STUDENT</B></h1>
...
<td><input type="button" name="display" value="DISPLAY" style="background-image:url(logo1.jpg);color:black; padding:2px 10px 2px 10px" onclick="displaybackpaperinfo(<%=rs1.getString(1)%>,<%=id_batch %>);" ></td>
