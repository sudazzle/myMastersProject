...
function displaygpamakeupinfo(id, id_batch){
   var f = document.form;
	f.method="post";
   f.action='gpamakeupinfodisplay.jsp?id='+id + '&id_batch=' + id_batch;
     f.submit();
}
</script>
...
<body>
  ...
  <div id="main">
    ...
    <div id="site_content">
        ...
        <h1><B>GPA-MAKEUP INFO: SELECT STUDENT</B></h1>
...
<td><input type="button" name="display" value="DISPLAY" style="background-image:url(logo1.jpg);color:black; padding:2px 10px 2px 10px" onclick="displaygpamakeupinfo(<%=rs1.getString(1)%>,<%=id_batch %>);" ></td>
