	  ...
	  // Connection conaa = null;
       ...
       Statement stttt;
		...
		{			
		    ...
		    pstatement.setString(2, "Back Paper");
		...
		response.sendRedirect("insertgradebackpaper.jsp");
	//response.sendRedirect("insertgradebackpaper.jsp?id="+student_id + "&id_batch=" + batch_id);
}
