    ...
    <div id="site_content">
        ...
        <p></p>
         ...
         <p><span><B>NAME:</B></span>&nbsp;&nbsp;&nbsp;<%
			...
			%></p>
<form method="post" action="update_backpaper.jsp">
<table>
		<tr><th width="60" >&nbsp;&nbsp;Code</th><th width="200">&nbsp;&nbsp;Subject Name</th><th width="20PX">&nbsp;Grade</th><th>&nbsp;Exam Type</th><th></th></tr>
			...
			try{	
				...
				Connection con_sem = DriverManager.getConnection("jdbc:mysql://localhost:8888/onlineresult", "root", "SUD@M@N");
						...
						String sem_query = "select subject.subject_code, subject.subject_name, marks.grade, marks.exam_type, marks.gradepoint from subject join course_offered on subject.subject_id = course_offered.subject_id join marks on course_offered.offer_id = marks.offer_id where marks.student_id =" + student_id + " and marks.exam_type = 'Back Paper' and marks.marks_id = " + marks_id;
