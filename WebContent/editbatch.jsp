...
<body>
  ...
  <div id="main">
    ...
    <div id="site_content">
        ...
        <h4>EDIT BATCH</h4>
<form method="post" action="update_batch.jsp">
<table>
<tr><th>START</th><th>END</th><th>PROGRAM</th><th></th></tr>
<%
...
String query = "select * from  batch where batch_id="+batch_id;
...
<td><input type="text" name="start" value="<%=rs.getInt(2)%>"></td>
<td><input type="text" name="end" value="<%=rs.getInt(3)%>"></td>
<td><input type="text" name="program" value="<%=rs.getString(4)%>"></td>
...
<td><input type="hidden" name="batch_id" value="<%=rs.getInt(1)%>"></td>
