...
function recordgpamakeup(id, id_batch){
   var f = document.form;
	f.method="post";
   f.action='insertgradegpamakeup.jsp?id='+id + '&id_batch=' + id_batch;
     f.submit();
}
</script>
...
<td><input type="button" name="record" value="RECORD" style="background-image:url(logo1.jpg);color:black; padding:2px 10px 2px 10px" onclick="recordgpamakeup(<%=rs1.getString(1)%>,<%=id_batch %>);" ></td>
