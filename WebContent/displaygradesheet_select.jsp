...
function displaygradesheet(id){
    var f=document.form;
    f.method="post";
    f.action='displaygradesheet_student_select.jsp?id='+id;
    f.submit();
}
...
<td><input type="button" name="SELECT" value="SELECT" style="background-image:url(logo1.jpg);color:black; padding:2px 10px 2px 10px" onclick="displaygradesheet(<%=rs.getString(1)%>);" ></td>
